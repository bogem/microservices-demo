...
func (*Text) Descriptor() ([]byte, []int) {
	return fileDescriptor_say_89d9ab73fb7066de, []int{0}
}
...
func (*Speech) Descriptor() ([]byte, []int) {
	return fileDescriptor_say_89d9ab73fb7066de, []int{1}
}
...
func init() { proto.RegisterFile("say.proto", fileDescriptor_say_89d9ab73fb7066de) }

var fileDescriptor_say_89d9ab73fb7066de = []byte{
